<template>
    <div id="form-view">
        <window-title small-title="| pridanie verzie" big-title="Nový záznam" />
        <div class="columns pt-1">
            <div class="column is-5 form-info">
                <div class="field">
                    <label class="label"><span class="has-text-danger">* </span>Číslo:</label>
                ...
                <div class="field">
                    ...
                    <div class="control has-icons-left">
                        <textarea class="textarea" placeholder="Bližšie informácie o verzie..."></textarea>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios
                .post("http://localhost:8080/api/project/" + this.actualProject + "/add/version", data, {
                    headers: {
