                ...
                <section>
                    ...
                    >
                        <b-table-column label="Akcie" width="200" v-slot="props">
                            <table-action-buttons resource="reproducibility" :id="props.row.id" />
                        </b-table-column>
...
export default {
    ...
    methods: {},
    mounted() {
        axios.get("http://localhost:8080/api/specification/?type=Reproducibility").then(response => (this.data = response.data));
    }
};
</script>
